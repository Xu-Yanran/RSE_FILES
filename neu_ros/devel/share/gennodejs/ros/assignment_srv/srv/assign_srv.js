...
class assign_srvRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type assign_srvRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type assign_srvRequest
    let len;
    let data = new assign_srvRequest(null);
  ...
  static datatype() {
    ...
    return 'assignment_srv/assign_srvRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new assign_srvRequest(null);
...
class assign_srvResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type assign_srvResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type assign_srvResponse
    let len;
    let data = new assign_srvResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new assign_srvResponse(null);
...
module.exports = {
  Request: assign_srvRequest,
  Response: assign_srvResponse,
  md5sum() { return '4781436a0c2affec8025955a6041e481'; },
  datatype() { return 'assignment_srv/assign_srv'; }
};
